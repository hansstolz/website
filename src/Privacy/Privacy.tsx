    ...
    <Main>
      <Content>
        <Left>
          ...
          Mail schicken, wie Ihr Name, Ihre Emailadresse, Ihr Mitteilung selbst.
        ...
        <Right>
          ...
          Beschwerde-recht bei der zuständigen Aufsichtsbehörde zu. Zuständige
          Aufsichtsbehörde in datenschutzrechtlichen Fragen ist der
          Landesdatenschutz Beauftragte des Bundeslandes, in dem unser
